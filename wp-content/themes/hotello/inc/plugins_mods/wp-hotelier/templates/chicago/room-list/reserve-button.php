...
<div id="reserve-rooms-button">
    ...
    <?php echo apply_filters('hotelier_reserve_button_html', '<input type="submit" class="button button--reserve" name="hotelier_reserve_rooms_button" id="reserve-button" value="' . esc_html__('Reserve', 'hotello') . '" />'); ?>
