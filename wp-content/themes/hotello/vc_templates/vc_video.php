...
global $wp_embed;
$embed = '<iframe allow="autoplay" width="950" height="534" src="' . esc_url($link) . '?feature=oembed" frameborder="0" allowfullscreen=""></iframe>';
...
if (!empty($preview)):
	$output .= '<div class="stm_video_preview" style="background-image:url(' . $preview . ')"><span></span></div>';
endif;
...
if (!empty($link)):
	wp_add_inline_script('hotello-app', "(function($) {
    'use strict';
