(function () {
    ...
    1: [function (require, module, exports) {
        ...
        exports.AppRootComponent = undefined;
            ...
            _createClass(AppRootController, [{
                ...
                value: function saveSettings() {
                    ...
                    this.$http({
                        ...
                        params: {
                            action: 'hotel_save_settings',
                            security: window.wp_data.hotello_save_settings
                        },
                        ...
                        _this.$http({
                            ...
                            method: 'POST',
                            params: {
                                action: 'hotel_update_custom_styles_admin',
                                security: window.wp_data.hotello_update_custom_styles_admin
                            }
                        }).then(function (res) {
    ...
    }, {"lodash": 54}], 2: [function (require, module, exports) {
        "use strict";
                ...
                value: function getSelectedImage(id) {
                    ...
                    this.$http({
                        ...
                        params: {
                            ...
                            action: 'hotel_get_thumbnail',
                            security: window.wp_data.hotello_get_thumbnail
                        }
                    }).then(function (res) {
        ...
        var MenuElementController = exports.MenuElementController = function () {
            function MenuElementController($mdDialog) {
                ...
                if (angular.isUndefined(this.element.data.sub)) {
                    this.element.data.sub = {};
                }
        ...
        "./../../../modals/builder/builder.modal": 48,
        "./../../builder-elements/address/address.element": 2,
        "./../../builder-elements/button/button.element": 3,
        "./../../builder-elements/buttonext/buttonext.element": 4,
        "./../../builder-elements/cart/cart.element": 5,
        "./../../builder-elements/dropdown/dropdown.element": 6,
        "./../../builder-elements/filter/filter.element": 7,
        "./../../builder-elements/font-resizer/font-resizer.element": 8,
        "./../../builder-elements/iconbox/iconbox.element": 9,
        "./../../builder-elements/icontext/icontext.element": 10,
        "./../../builder-elements/image/image.element": 11,
        "./../../builder-elements/menu/menu.element": 12,
        "./../../builder-elements/offices/offices.element": 13,
        "./../../builder-elements/popup/popup.element": 14,
        "./../../builder-elements/search/search.element": 15,
        "./../../builder-elements/signin/signin.element": 16,
        "./../../builder-elements/socials/socials.element": 17,
        "./../../builder-elements/text/text.element": 18,
        "./../../builder-elements/weather/weather.element": 19
        ...
        var SelectControlController = function () {
            ...
            _createClass(SelectControlController, [{
                key: '$onInit',
                value: function $onInit() {
                    if (!(this.data.value in this.data.choices)) {
                        this.data.value = Object.keys(this.data.choices)[0];
                    }
                }
            }, {
                key: 'checkValue',
        ...
        var elementPaddings = exports.elementPaddings = function elementPaddings(siteBreakpoints) {
            "use strict";
            ...
            return {
                ...
                templateUrl: ngAppPath + 'directives/element-paddings/element-paddings.directive.html'
            };
        };
        ...
        var _elementPaddings = require('./directives/element-paddings/element-paddings.directive');
        ...
        "./components/app-root/app-root.component": 1,
        "./components/controls/builder/builder.control": 20,
        "./components/controls/checkbox/checkbox.control": 21,
        "./components/controls/colorpicker/colorpicker.control": 22,
        "./components/controls/default/text.control": 23,
        "./components/controls/divider/divider.control": 24,
        "./components/controls/font/font.control": 25,
        "./components/controls/fontcommon/fontcommon.control": 26,
        "./components/controls/iconpicker/iconpicker.control": 27,
        "./components/controls/image/image.control": 28,
        "./components/controls/posttype/posttype.control": 29,
        "./components/controls/radio/radio.control": 30,
        "./components/controls/select/select.control": 31,
        "./components/controls/slider/slider.control": 32,
        "./components/controls/socials/socials.control": 33,
        "./components/controls/switch/switch.control": 34,
        "./components/controls/textarea/textarea.control": 35,
        "./constants": 36,
        "./directives/color-selector/color-selector.directive": 37,
        "./directives/control-generator/control-generator": 38,
        "./directives/element-control/element-control.directive": 39,
        "./directives/element-margins/element-margins.directive": 40,
        "./directives/element-paddings/element-paddings.directive": 41,
        "./directives/fontcolorpicker/fontcolorpicker.directive": 42,
        "./directives/hider/hider.directive": 43,
        "./directives/icons-list/icons-list.directive": 44,
        "./directives/materialForm/materialForm": 45,
        "./fitlers/trustHtml": 46,
        "./run/run": 49,
        "./services/dialog.service": 50,
        "./services/history.service": 51,
        "./services/previewGenerator": 52,
        "./services/wpMedia.service": 53
        ...
        exports.WpMediaService = undefined;
    ...
    }, {"lodash": 54}], 54: [function (require, module, exports) {
        (function (global) {
            /**
             * @license
