...
<span class="rate__non-cancellable-info rate__non-cancellable-info--single"><?php echo esc_html(apply_filters('hotelier_single_room_non_cancellable_info_text', __('Non-refundable', 'hotello'))); ?></span>
