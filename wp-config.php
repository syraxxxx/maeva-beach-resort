...
define( 'DB_NAME', 'beuslg6ptlmbwe6w5vuv' );

/** Database username */
define( 'DB_USER', 'uu65aml4iccyssib' );

/** Database password */
define( 'DB_PASSWORD', '4HQoPhesLkFgHrdkwfbY' );

/** Database hostname */
define( 'DB_HOST', 'beuslg6ptlmbwe6w5vuv-mysql.services.clever-cloud.com' );
