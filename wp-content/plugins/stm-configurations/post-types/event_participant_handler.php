...
add_action('wp_ajax_hotello_event_participant', 'hotello_event_participant');
add_action('wp_ajax_nopriv_hotello_event_participant', 'hotello_event_participant');
function hotello_event_participant() {
	$r = array(
		'errors' => array(),
		'message' => '',
		'status' => ''
...
add_action('hotello_notify_user', 'hotello_notify_user_function', 10, 4);

function hotello_notify_user_function($id, $email, $title) {
